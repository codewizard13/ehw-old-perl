...
################################################################################
##
## FILE:      ehBookmarksConverter.pl
## CREATOR:   Eric Hepperle
## DATE:      06/04/11
##
## PURPOSE:   Takes an exported Internet Explorer bookmarks file and converts
##            to a styled functional list.
##
##
## NOTES:     06/04/11, 18:06 - Created file.
