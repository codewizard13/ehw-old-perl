...
#
#
# Program:	permut_0to9_3dig.pl
# Creator:	Eric Hepperle
# Date:	01/24/02
#
# Purpose:	Simple demonstration of using the pack command to develop all possibilities acchievable for this three (3) digit combination.
#
###################################################
#
# Revisions:
...
print "\n\n";
print "This program is called permut_0to9_3dig.pl\n\n";
