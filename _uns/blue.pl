#!/usr/bin/perl
# File blue.pl created by Brian Raver at 08:18:51 on Mon Jul 24 2000.
# 02/14/2001  PJW - modified the code to search two directories.

# This command does a lookup in bluepages and returns the attributes listed in the command for all employees in the "rocheste" directory. It is opened in a pipe so that we can format the data as it comes in.
