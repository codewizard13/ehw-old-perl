#!/usr/bin/perl
# File eh_myhtmlgen1.pl created by Eric Hepperle at 08:37:57 on Fri Aug 
17
2001.
#
...
$maindir = "file:///c:/etc/tmp";
$docname = "html_test_doc.html";
#$webfile = "$maindir/$docname";
#$titletext = "This is a test web page generated by my perlscript 
webpage
creator";
...
print HTML_DOC "\n";
print HTML_DOC "\.time \{font-family:  \"Gill Sans\", \"Tahoma\", 
\"Arial\"
\; font-size: 10pt\; color: red\}\n";
print HTML_DOC "\.date \{ font-family:  \"Tahoma\",\"Gill 
Sans\",\"Arial\"
\; font-size: 12pt\; color: lightslateblue\}\n";
print HTML_DOC "\n";
print HTML_DOC "</STYLE>\n";
print HTML_DOC "\n";
...
sub printfile {
        ...
        open (IN, $templogfile) || die "Cannot open $templogfile for 
read :
$!";
...
$templogfile \n";
   ...
   print TEMPLOG "<TR>\n";
   print TEMPLOG "\n";
   print TEMPLOG "   <TD WIDTH = 70 VALIGN = TOP><H6 CLASS =
\"time\">$event_time</H6>\n";
   print TEMPLOG "   </TD>\n";
   print TEMPLOG "\n";
...
open (TEMPTABLE, ">$temptablefile") || die "cannot open specified file
$temptablefile \n";
