#!/usr/bin/perl
# File aixledcode_make.pl created by Eric Hepperle at 11:11:00 on Thu Jun  7 2001. 
#
# This program lets a user enter in an AIX LED error code and it will
# output the meaning of that code per "Service Request Number
# Cross-Reference Version 4.1"
