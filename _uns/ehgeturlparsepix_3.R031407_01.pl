#!/usr/bin/perl
#
# Program:	ehgeturlparsepix_3.pl
# Creator:	Eric Hepperle
# Date:		08/29/01
#
# Purpose:	Various pieces of code to try in the ehgeturlparsepix.pl script.
#
#		Rips HTML source code from a
...
# 2007.Mar.14 - Updated for XP
# $dir = "/afs/rchland.ibm.com/usr3/v2cib484/ehtestdir";
$dir = `%userprofile%\desktop\ehtestdir`;
$webfile = "$dir/$docname";
