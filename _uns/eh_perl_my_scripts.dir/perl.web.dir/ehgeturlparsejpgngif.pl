...
# Date:		06/27/01
#
# Purpose:	This program will rip the source code of any url. It will now also save the source as an html document in a specified folder.  Currently, it only downloads text (HTML), not the corresponding images.
#
#		WORKS GOOD !!!  --> Gets HTML source
#				    code but not pix.
#
###################################################
...
print "\n";
print "The file $webfile was created successfully!\n\n";
