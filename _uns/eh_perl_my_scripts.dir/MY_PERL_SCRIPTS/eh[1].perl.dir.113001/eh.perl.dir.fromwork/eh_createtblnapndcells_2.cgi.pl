...
#
# Program:	eh_createtblnapndcells_2.cgi.pl
# Creator:	Eric Hepperle
# Date:		08/22/01
#
# Purpose:	Lets user maintain a log of daily events.  Very versatile and can be used as a guestbook, problem logger, etc...  This version does not format the page w/ the <BR> tag, so newline chars are not recognized and everything gets squished together.
#
########################################################
#
# Revisions:
