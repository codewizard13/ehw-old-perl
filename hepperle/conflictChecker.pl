...
# File:        conflictChecker.pl
# Author:      Eric Hepperle
# Created:     03/23/12
#
# Purpose:     Batch checking for svn (subversion) merge conflicts.
#
# Usage:
#
#			   	$> svnConflictChecker.pl <branch1> <branch2> ... <branch(n)>
#
#				   "branch" is a checked out branch residing on your local system,
#					as a direct child (subdir) of the current directory.
#
