...
#
# Program:        recursive_changeIcon_060906.pl
# Creator:        Eric Hepperle
# Date:           06/09/06
#
# Purpose:        Recursiveley copy an icon file into nested subfolders.
#
######################################
#
...
$htmlfile = "$outdir\\desktop\\icondirlist.html";
print "\$htmlfile = \t$htmlfile\n\n";
$textfile = "$outdir\\desktop\\icondirlist.txt";
print "\$textfile =\t$textfile\n\n";

# Define the icon file to use
print "Enter full path to icon file:\n";
$ans = <STDIN>;
chomp($ans);
$iconfile = $ans;
print "The icon file that will be used is:\n";
print "$iconfile\n\n";
