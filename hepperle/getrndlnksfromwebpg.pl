...
# Date:	11/29/01
#
# Purpose:	Based on the ActivePerl Documentation example for HTML::LinkExtor.  Gets a random link from a given url. This script gives diagnostic output and tracing to show how it works (added by me).
#
###################################################
#
# Revisions:
