...
#
# REVISIONS:   05/28/03
#              - Wrote code to display day and month.
#
#              07/03/03
#              - Added code to create out file
#
#---------------------------------------------------
...
sub createOutFile
{
   $outJavaFile = "$progFolder/$progName\.java";
   print "\$outJavaFile = $outJavaFile\n\n";

   &makeFile( $outJavaFile );

   open(OUT, ">$outJavaFile");
      print OUT "$shebang\n";
      print OUT "#\n";
      print OUT "# Program:     $progName\n";
      print OUT "# Creator:     $creator\n";
      print OUT "# Date:        $mmddyy_withSlash\n";
      print OUT "#\n";
      print OUT "# Purpose:     @progDescription\n";
      print OUT "#\n";
      print OUT "$methSpace";
...
sub displayThisFileInfo
{
   ...
   print "The Date is:                   $mmddyy_withSlash\n\n";
   print "\n\n";
   print "$border\n\n";
