#!/usr/bin/perl
#
# Program:	uncataloged_htmlmatch2.pl
# Creator:	Eric Hepperle
# Date:		10/05/01
#
# Purpose:	Not my script.  Supposed to walk "...the web of files starting with those listed in "infile", and makes a list of titles and urls."  Doesn't work.
#
# Taken from:
#
