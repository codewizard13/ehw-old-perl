#!/usr/bin/perl
#
# Program:	ehformreader.pl
# Creator:	Eric Hepperle
# Date:		08/16/01 
#
# Purpose:	Not my script.  Form reader program.  This one seems to work.  Need to read and figure out it's mechanics.
#
##################################################
...
#$email = "my\@mail.com";
#
# I added this input code for testing: (elh, 08/16/01).
#
